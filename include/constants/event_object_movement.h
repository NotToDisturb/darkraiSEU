...
// new movements
#define MOVEMENT_ACTION_WALK_SLOWEST_UP_BACKWARDS       0x9E
#define MOVEMENT_ACTION_WALK_SLOWEST_DOWN_BACKWARDS     0x9F
#define MOVEMENT_ACTION_WALK_SLOWEST_RIGHT_BACKWARDS    0xA0
#define MOVEMENT_ACTION_WALK_SLOWEST_LEFT_BACKWARDS     0xA1
#define MOVEMENT_ACTION_WALK_SLOW_UP_BACKWARDS          0xA2
#define MOVEMENT_ACTION_WALK_SLOW_DOWN_BACKWARDS        0xA3
#define MOVEMENT_ACTION_WALK_SLOW_RIGHT_BACKWARDS       0xA4
#define MOVEMENT_ACTION_WALK_SLOW_LEFT_BACKWARDS        0xA5
#define MOVEMENT_ACTION_WALK_NORMAL_UP_BACKWARDS        0xA6
#define MOVEMENT_ACTION_WALK_NORMAL_DOWN_BACKWARDS      0xA7
#define MOVEMENT_ACTION_WALK_NORMAL_RIGHT_BACKWARDS     0xA8
#define MOVEMENT_ACTION_WALK_NORMAL_LEFT_BACKWARDS      0xA9
#define MOVEMENT_ACTION_WALK_FAST_UP_BACKWARDS          0xAA
#define MOVEMENT_ACTION_WALK_FAST_DOWN_BACKWARDS        0xAB
#define MOVEMENT_ACTION_WALK_FAST_RIGHT_BACKWARDS       0xAC
#define MOVEMENT_ACTION_WALK_FAST_LEFT_BACKWARDS        0xAD
#define MOVEMENT_ACTION_JUMP_2_UP_BACKWARDS             0xAE
#define MOVEMENT_ACTION_JUMP_2_DOWN_BACKWARDS           0xAF
#define MOVEMENT_ACTION_JUMP_2_RIGHT_BACKWARDS          0xB0
#define MOVEMENT_ACTION_JUMP_2_LEFT_BACKWARDS           0xB1
#define MOVEMENT_ACTION_JUMP_UP_BACKWARDS               0xB2
#define MOVEMENT_ACTION_JUMP_DOWN_BACKWARDS             0xB3
#define MOVEMENT_ACTION_JUMP_RIGHT_BACKWARDS            0xB4
#define MOVEMENT_ACTION_JUMP_LEFT_BACKWARDS             0xB5
